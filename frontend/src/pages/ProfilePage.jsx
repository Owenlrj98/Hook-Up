...
//       <Container>
//         <div className="pages-box-shadow p-3 mt-3">
//           <h5 className="h3-custom">{profile.name === null ? "Edit Profile" : "Create Profile"}</h5>
//           <Form onSubmit={handleSubmit} className="mt-3">
//             <Form.Group controlId="formName">
//               <Form.Label>Name</Form.Label>
//               <Form.Control
...
//                 </Dropdown.Toggle>
//                 <Dropdown.Menu>
//                   <Dropdown.Item onClick={() => handlePreferenceSelect("Beginner")}>
//                     Beginner
//                   </Dropdown.Item>
//                   <Dropdown.Item onClick={() => handlePreferenceSelect("Intermediate")}>
//                     Intermediate
//                   </Dropdown.Item>
//                   <Dropdown.Item onClick={() => handlePreferenceSelect("Advanced")}>
//                     Advanced
//                   </Dropdown.Item>
//                 </Dropdown.Menu>
//               </Dropdown>
